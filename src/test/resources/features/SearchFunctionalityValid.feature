@Regression
Feature: Trade Jorunal Search Functionality Valid tests
...
Scenario: search functionality valid Symbol test  
  When I enter a value for ‘Symbol' textbox,
And I click on the 'Search’ Button
Then 	The system should filter the existing list of trades associated with the Symbol
...
Scenario:  search functionality valid date test
  When I enter a value for ‘Date' textbox,
And I click on the 'Search’ Button
...
Scenario: search functionality valid symbol and date test
  When I enter a value for ‘Symbol' textbox,
  And I enter a value for 'Date' textbox
And I click on the 'Search’ Button
